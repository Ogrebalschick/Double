<?php 
    ...
    //проверка на существование одинакового email
		...
		if ( empty($errors) )
		{
			...
			R::store($user);
			echo '<div style="color:dreen;">Пользователь успешно зарегистрирован!</div><hr>';
		}else
		{
...
<form action="/signup.php" method="POST">
	...
	<button type="submit" name="do_signup">Регистрация</button><br>
	<a href="/admin/">главная</a><br>
	<a href="/admin/users-admin.php">назад</a><br>
</form>